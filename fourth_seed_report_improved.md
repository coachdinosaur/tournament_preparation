...
- **Best possible target when Dino has White:** investigate the **Advance Caro-Kann** signal
...
- **Most realistic White-game fit:** stay closer to Dino's anti-Sicilian base. Tan scores well in
  the Anti-Sicilian family (**81.2%**), but the engine found serious errors there (**ACPL 41.2**,
  **18 serious errors over 227 moves**). This is a target because the engine found pressure points,
  not because his results are poor.
- **Best possible target when Dino has Black:** meet Tan's English/Reti move orders with a prepared
...
high-scoring anti-Sicilian structures still show engine strain.
...
| Anti-Sicilian Counter-Package as Black | B-file systems | 8 | 81.2% | Engine shows strain, but he scores well; target only with real prep |
...
| Zukertort Opening: Kingside Fianchetto as White | A04 | 2 | 0.0% | Possible Black target; small sample, same flank-opening theme |
| English Symmetrical: Anti-Benoni / Spielmann as White | A32 | 2 | 25.0% | Useful anti-English branch to review |
| Modern Defense: Standard Defense as Black | B06 | 2 | 0.0% | Possible White target against his ...g6/...d6 setup |
...
| Reversed-Sicilian / Flank Annexation | Black | 3 | 66.7% | 95 | **65.6** | **9** | Engine-pressure target, not a result weakness |
...
| Fianchetto KID / Grunfeld Complexes | Black | 4 | 50.0% | 142 | 39.5 | 11 | Engine shows strain, but target is unclear |
...
- **Steer toward with White if trained:** Advance Caro-Kann. It has both result weakness and engine
  strain, but Dino's own file has zero reps, so training must come first.
...
- **Do not overread:** Reversed-Sicilian/flank structures have the highest ACPL, but Tan still
  scores 66.7% there. Use the engine strain as a training pointer, not as proof of a result
  weakness.
