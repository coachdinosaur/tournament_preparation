#!/usr/bin/env python
"""Build the Arlan Cabe round-by-round playbook DOCX.

Mirror of build_playbook.py for Cabe's standalone playbook. Reuses
build_standalone_report.render_report() unchanged, then sets
...
STEM = "Arlan_Cabe_Round_by_Round_Game_Preparation"
