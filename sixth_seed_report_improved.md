...
- **This is a genuinely classical file — no speed-game inflation problem.** Only **1 of 101** games is a
...
- **Recency:** the file spans 2002–2026, but **70 of the classical games are from 2023 onward** and he
  is currently active, so the dossier is **current enough to trust**. The **18 pre-2010 games are
...
- **Best structural target — but a workload one: the Catalan/Réti squeeze against his Black.** With
  ...
  But his ACPL there is a clean **17.8** — the line works by preparation and pressure, not by waiting
  for cheap blunders — and, critically, **reaching it needs a Réti/KIA/g3 move-order, which is not Dino's standard 1.e4.**
...
- **Useful confidence point:** Dino has **already beaten him** — the one non-classical game on file is an Oct 2025
...
| Sicilian: Najdorf, Lipnitsky Attack | B90 | 2 | 75.0% | He meets the Najdorf directly; not a target |
...
> **Practical reading:** do not expect him to blunder more than Dino. The realistic edge is to keep
> pressure into long games and the move-30+ phase (see §5), where his accuracy dips and his 2024
> results show real cracks, rather than to expect a quick tactical gift.

---

## 4. Middlegame and Structure Notes

*Classical-only structure split by Susilodinata's color (results **and** engine accuracy).*

| Structure family | His color | Games | Result % | ACPL | B/M | Read |
|---|---|---:|---:|---:|---:|---|
| Catalan / Réti Squeeze | Black | 9 | **38.9%** | 17.8 | 1/5 | **Top result target**; clean ACPL means win by preparation, not cheap blunders; needs a Réti/KIA move-order |
...
- **Steer toward (with prep): the Catalan/Réti squeeze vs his Black.** 38.9% over 9 classical games is
  his clear soft spot, but the clean ACPL (17.8) means he is being outplayed in the line, not handing
  over easy blunders. Worth it **only** if Dino will prepare a KIA/Réti/g3 route to it.
...
8. **Use the confidence point sensibly.** Dino already beat him once (Oct 2025 rapid, Dino's Alapin as Black).
...
- **Coverage:** 101 total games, 101 OTB PGNs, 0 Lichess records without full move lists, **101/101
  analysed at depth 12**, 0 pending. The shipped dossier's stale 2-game depth-16 cache was discarded and the full set
...
- **Known limitations:** depth 12 is a screening depth, not final engine truth; classical family
  samples are 3–9 games each; result targets and engine-accuracy targets are checked against each
  other (the Catalan/Réti and Advance-Caro reads both note that he plays cleanly by ACPL).
