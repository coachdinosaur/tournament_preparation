...
Ang is the lowest-rated of the eight opponents, but the single most important fact about this
...
strength faster than the rating list updates, and his **entire 100-game file is fresh (Nov 2023 to
Dec 2025, 57 games in 2025 alone)** with zero ancient junior games to discount. **Do not prepare him
as only a 2309 — treat 2309 as a floor.**
...
- **His weak side is the one Dino actually faces with White.** In classical play Ang is **18-13-9
  ...
  — the danger pairing.
- **Dino's confidence weapons are relevant here** (unlike vs Thejkumar). As Black, Ang answers
...
- **The cleanest structural target plays straight to Dino's biggest strength.** As Black in an
  **Anti-Sicilian Counter-Package** structure Ang is **0-0-2 (0.0%) with a very poor ACPL 38.3**
  (small sample, 2 classical games) — and that family is **Dino's single best domain (96.0% over 25
  games)**. Meeting Ang's Sicilian with a Bb5 anti-Sicilian denies his strength and invites his
  weakest structure.
- **He is less comfortable when rushed, not when calculating slowly.** His **blitz (1993) trails his
  standard (2309) by ~300 points** — a typical junior pattern. In a classical game that converts to:
...
**As White — 40 classical games, 61.2%.** A g3-based player: 1.d4 / 1.Nf3 / 1.c4 into Catalan, Réti,
...
|---|---|---:|---:|---|
| King's Indian Attack | A07 | 4 | **37.5%** | **Weakest White line by result (1-1-2)** and the home of his late blunders (§5) — but hard for Dino's Black repertoire to steer into |
...
| King's Indian Attack: Spassky Variation | A05 | 2 | 25.0% | Weak result (0-1-1), same KIA family as A07 |
...
| Ruy Lopez: Closed, Breyer/Zaitsev Hybrid | C95 | 2 | 25.0% | Weak result (0-1-1); his 1...e5 complex leaks generally |
| Ruy Lopez: Closed, Anti-Marshall | C88 | 2 | 50.0% | Even |
| Slav Defense: Exchange | D10 | 2 | 50.0% | Draw-prone (0-2-0); not a target |
| English: Symmetrical, Fianchetto | A34 | 2 | 25.0% | Weak result, but arises vs 1.c4 — won't occur vs Dino's 1.e4 |
...
- **Dino's e4 weapons apply — this is the opposite of the Thejkumar pairing.** Ang as Black plays
  ...
  (100%) are live here**, where against Thejkumar they were not relevant.
...
*The all-games overall/endgame figures are dominated by the online half and are shown only to show
the speed-game inflation; use the classical row for every verdict. Note Ang actually **scores** better online
...
they cluster in the **late middlegame / move-30+ transition** (see §5). This is a normal, slightly
  loose-late junior profile, **not** an endgame liability — phrase any endgame edge as "make him work,"
not "he collapses."

> **Underrated caveat (read this against the accuracy table, not instead of it).** These numbers
...
*Classical-only structure split by Ang's color (results **and** engine accuracy, which are separate
evidence types).*

| Structure family | His color | Games | Result % | ACPL | B/M | Read |
|---|---|---:|---:|---:|---:|---|
| Catalan / Réti Squeeze | White | 27 | 55.6% | 19.7 | 8/14 | His main White structure (10-10-7); beatable — losses to Romanov (GM) and others, with real blunders |
...
| vs Romanov, Evgeny (Bangkok, Apr 2025) | 38.Rg3 / 34.Rxg4 | two blunders | Outplayed in a Catalan Closed by a 2600+ GM | Kh5-h4 / Rg2xg4 |
...
4. **With Black (the hard game), refuse the squeeze.** Avoid a symmetrical Catalan and **never walk
   ...
   (Dino's familiar structure), or his **100% Neo-Grünfeld** — pose problems instead of being ground down.
...
6. **Tighten Dino's own Black and drawing-defense first.** Dino-Black meets Ang's stronger side; with
   Dino's 73.3% Black score, his repeated Dragon-line losses (not relevant here — Ang never plays 1.e4), and
...
- **Coverage:** 100 total games, 100 OTB PGNs, 0 Lichess records without full move lists, **100/100
  analysed at depth 12**, 0 pending. The shipped dossier's partial 15-of-100 cache (depth 16) was discarded and the full set
...
- **Time-control split:** 79 classical vs 21 online (chess.com Titled Tuesday). All accuracy and
  ...
  PGNs.
- **Recency:** the file spans **Nov 2023 to Dec 2025** with **no pre-2010 games** and **57 of 100 in
  2025**. Unusually for this project the recency caution **goes the other way**: the evidence is current, and a
...
- **Underrated caveat:** born 2010, FM 2025, blitz 1993 is far below standard 2309. Every percentage here is a
...
- **Known limitations:** depth 12 is a screening depth, not final engine truth; the standout
  anti-Sicilian and IQP targets rest on 2-game samples (flagged as pointers); result targets and
  engine-accuracy targets are checked against each other (his Catalan/Réti is soft by result *and*
  shows real blunders, while his fianchetto-KID is clean on both counts).
